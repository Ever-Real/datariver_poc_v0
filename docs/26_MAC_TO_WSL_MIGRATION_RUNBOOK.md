...
If durable PDF analysis is selected, require current Alembic head `0064` (the durable job schema was
...
Require `0064 (head)` after migration. Revision `0054` refuses a missing, privileged, BYPASSRLS or
