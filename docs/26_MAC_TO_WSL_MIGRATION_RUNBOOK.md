...
If durable PDF analysis is selected, require current Alembic head `0065` (the durable job schema was
...
Require `0065 (head)` after migration. Revision `0054` refuses a missing, privileged, BYPASSRLS or
