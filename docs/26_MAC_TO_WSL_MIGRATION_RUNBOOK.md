...
It pulls only repository digest-pinned external images, builds repository-owned images, preserves
volumes and does not create or claim offline release evidence.
