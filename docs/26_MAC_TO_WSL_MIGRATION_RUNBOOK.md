...
repository-owned images, preserves volumes and does not create or claim offline release evidence.
Managed offline acceptance continues to require the recorded manifest, checksums and image IDs.
