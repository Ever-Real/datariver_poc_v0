...
| 3 | manual and bulk registration | IN PROGRESS — WORKBENCH/CREATE-TIME GUARDS | source/unit and live Vite/API/APISIX contract gates pass. Typed ordinary-edit DTOs, apply-time target/policy reauthorization, target serialization/CAS, accepted-content binding, preview/correction, authenticated browser E2E and object-manifest evidence remain |
