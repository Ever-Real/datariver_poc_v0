...
- Liveness is process-only. Readiness leases the API pool and requires exactly packaged Alembic head `0014`; Compose and APISIX use readiness for upstream health.
