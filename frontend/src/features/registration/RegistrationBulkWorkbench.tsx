    ...
    <div className="registration-bulk-workbench">
      <aside className="registration-bulk-sidebar panel">
        ...
        <form className="registration-upload-form" onSubmit={(event) => void upload(event)}>
          ...
          <progress className="progress-track" aria-label="업로드 진행률" aria-valuemin={0} aria-valuemax={100} aria-valuenow={Math.round(progress * 100)} max={100} value={Math.round(progress * 100)} />
