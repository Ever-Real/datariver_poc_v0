  ...
  return <div className="grid gap-3">
    ...
    <div className="admin-two-column role-access-admin">
      <section className="panel form-stack">
        <div className="section-heading"><div><h3>사용자 Role 할당</h3><p className="muted">인증 계정은 User 관리에서 등록하고, 플랫폼 권한은 이 Role로 관리합니다.</p></div><button type="button" className="button button-secondary" onClick={() => void loadDirectory()}>새로고침</button></div>
