...
const ko: AdminMessages = {
  ...
  auditLogs: 'Audit/Log 조회', metadataLogs: '메타데이터 변경 로그', securityLogs: '시스템 보안 로그', dictionary: '용어사전', featurePermissions: '기능별 권한', siteManagement: '사이트 관리',
...
const en: AdminMessages = {
  ...
  auditLogs: 'Audit/Log review', metadataLogs: 'Metadata change log', securityLogs: 'System security log', dictionary: 'Terminology dictionary', featurePermissions: 'Feature access', siteManagement: 'Site management',
