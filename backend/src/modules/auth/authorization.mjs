...
export const POC_ROUTE_REGISTRY = Object.freeze([
  ...
  route('catalog.glossary-assignment-counts', 'POST', /^\/poc-api\/datahub\/glossary\/assignments\/batch-counts$/, 'CAPABILITY_PROTECTED', 'catalog.read'),
  route('catalog.export-capability', 'GET', /^\/poc-api\/datahub\/catalog\/export-capability$/, 'CAPABILITY_PROTECTED', 'catalog.read'),
  route('catalog.export-create', 'POST', /^\/poc-api\/datahub\/catalog\/exports$/, 'CAPABILITY_PROTECTED', 'catalog.read'),
  route('catalog.export-status', 'GET', /^\/poc-api\/datahub\/catalog\/exports\/[^/]+$/, 'CAPABILITY_PROTECTED', 'catalog.read'),
  route('catalog.export-download', 'POST', /^\/poc-api\/datahub\/catalog\/exports\/[^/]+\/download$/, 'CAPABILITY_PROTECTED', 'catalog.read'),
  route('catalog.export-file', 'GET', /^\/poc-api\/datahub\/catalog\/exports\/[^/]+\/file$/, 'CAPABILITY_PROTECTED', 'catalog.read'),
  ...
  route('chat.sessions.list', 'GET', /^\/poc-api\/chat\/sessions$/, 'CAPABILITY_PROTECTED', 'chat.query'),
  route('chat.messages.list', 'GET', /^\/poc-api\/chat\/sessions\/[^/]+\/messages$/, 'CAPABILITY_PROTECTED', 'chat.query'),
  route('chat.session.favorite', 'PATCH', /^\/poc-api\/chat\/sessions\/[^/]+\/favorite$/, 'CAPABILITY_PROTECTED', 'chat.query'),
  route('chat.session.archive', 'DELETE', /^\/poc-api\/chat\/sessions\/[^/]+$/, 'CAPABILITY_PROTECTED', 'chat.query'),
