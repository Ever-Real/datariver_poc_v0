...
_SYSTEM_ENVIRONMENT_KEYS: dict[str, tuple[str, ...]] = {
    "PLATFORM_RUNTIME": (
        ...
        "KNOWLEDGE_STUDIO_PROPOSAL_WORKER_SUBJECT_ID",
        "KNOWLEDGE_STUDIO_PROPOSAL_WORKSPACE_ID",
        "KNOWLEDGE_STUDIO_PROPOSAL_WORKER_FINGERPRINT",
        "KNOWLEDGE_STUDIO_PROPOSAL_WORKER_POLL_SECONDS",
        "KNOWLEDGE_STUDIO_PROPOSAL_WORKER_LEASE_SECONDS",
        "KNOWLEDGE_STUDIO_PROPOSAL_JOB_MAXIMUM_ATTEMPTS",
        "KNOWLEDGE_STUDIO_PROPOSAL_MEMORY_SPOOL_BYTES",
        "KNOWLEDGE_STUDIO_PROPOSAL_SPOOL_DIRECTORY",
        "KNOWLEDGE_STUDIO_INGESTION_WORKER_ENABLED",
        "KNOWLEDGE_STUDIO_INGESTION_WORKER_SUBJECT_ID",
        "KNOWLEDGE_STUDIO_INGESTION_WORKSPACE_ID",
        "KNOWLEDGE_STUDIO_INGESTION_WORKER_FINGERPRINT",
        ...
        "KNOWLEDGE_STUDIO_INGESTION_WORKER_POLL_SECONDS",
        "KNOWLEDGE_STUDIO_INGESTION_WORKER_LEASE_SECONDS",
        "KNOWLEDGE_STUDIO_INGESTION_SOURCE_HARD_TIMEOUT_SECONDS",
        "KNOWLEDGE_STUDIO_INGESTION_COMPLETION_MARGIN_SECONDS",
    ),
    "POSTGRESQL": (
        "POSTGRES_DB",
        "POSTGRES_USER",
