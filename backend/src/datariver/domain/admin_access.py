...
class AdminOperation(StrEnum):
    IDENTITY_USER_PROVISION = "IDENTITY_USER_PROVISION"
    IDENTITY_USER_PROFILE_READ = "IDENTITY_USER_PROFILE_READ"
    IDENTITY_USER_PROFILE_UPDATE = "IDENTITY_USER_PROFILE_UPDATE"
    IDENTITY_USER_PASSWORD_RESET = "IDENTITY_USER_PASSWORD_RESET"  # noqa: S105
    MEMBERSHIP_ACCESS_READ = "MEMBERSHIP_ACCESS_READ"
    MEMBERSHIP_ACCESS_UPDATE = "MEMBERSHIP_ACCESS_UPDATE"
    MEMBERSHIP_RENEWAL_READ = "MEMBERSHIP_RENEWAL_READ"
    MEMBERSHIP_RENEWAL_DECIDE = "MEMBERSHIP_RENEWAL_DECIDE"
    ...
    SYSTEM_CONFIGURATION_ACTIVATE = "SYSTEM_CONFIGURATION_ACTIVATE"
    MONITORING_CONFIGURATION_READ = "MONITORING_CONFIGURATION_READ"
