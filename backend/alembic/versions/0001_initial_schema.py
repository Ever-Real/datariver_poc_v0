...
def upgrade() -> None:
        ...
        op.create_index('ix_assets_projection_workspace_watermark', 'assets_projection', ['workspace_id', 'updated_at'], unique=False, schema='catalog')
